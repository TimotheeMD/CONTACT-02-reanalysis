...
subset_treat_1 <- newdata[newdata$treat == 1 & newdata$time >= EstartTime & newdata$time <= endTime,]
...
subset_treat_0 <- newdata[newdata$treat == 0 & newdata$time >= CstartTime & newdata$time <= endTime,]
